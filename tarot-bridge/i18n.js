...
const translations = {
    en: {
        ...
        upright_suffix: "(U)",
        reversed_suffix: "(R)",
        prompt_template: 'I asked Tarot: {question}. I drew {cards}... Interpret this?',
    ...
    'zh-TW': {
        ...
        upright_suffix: "(正)",
        reversed_suffix: "(逆)",
        prompt_template: '我問了塔羅牌：「{question}」。我抽到了：{cards}... 請為我解牌？',
    ...
    'zh-CN': {
        ...
        upright_suffix: "(正)",
        reversed_suffix: "(逆)",
        prompt_template: '我问了塔罗牌：“{question}”。我抽到了：{cards}... 请为我解牌？',
    ...
    ja: {
        ...
        upright_suffix: "(正)",
        reversed_suffix: "(逆)",
        prompt_template: '私はタロットに尋ねました：「{question}」。引いたカード：{cards}... これを解釈してください。',
    ...
    ko: {
        ...
        upright_suffix: "(정)",
        reversed_suffix: "(역)",
        prompt_template: '타로에게 물었습니다: "{question}". 뽑은 카드: {cards}... 이것을 해석해 주시겠습니까?',
